...
module.exports = {
  ...
  onStart: async function ({ message, api, event, usersData, threadsData }) {
    ...
    const botName = SANNY-ROBOT;
    const botPrefix = "+";
    const authorName = Mr Sanny;
    const authorFB = "https://www.facebook.com/profile.php?id=100057678948022";
    const authorInsta = "https://www.instagram.com/lover_boy_you_and_me?igsh=MTl6am5tZDY3cHc2YQ==";
    const authorEmail = mohammad sanny666@gmail.com;
    const authorGithub = "praivet☂️ ";
    const status = "𝙎𝙞𝙣𝙜𝙡𝙚";
...
=====================`;
  ...
  onChat: async function({ event, message, getLang }) {
    if (event.body &&.body.toLowerCase() === "info") {
